...
class User(db.Model):                                                                                                                                               # 사용자
    ...
    gender = db.Column(db.String(20), nullable=False)                                                                                                               # 성별              # 필수입력
...
class Places(db.Model):                                                                                                                                             # 여행지
    ...
    admission_type = db.Column(db.Boolean, nullable=False)                                                                                                          # 입장료 유무       # 필수입력
    admission_detail = db.Column(db.Text, nullable=True)                                                                                                            # 입장료 상세
    parking_available = db.Column(db.Boolean, nullable=False)                                                                                                       # 주차장 유무       # 필수입력
    parking_capacity = db.Column(db.String(120), nullable=True)                                                                                                     # 주차장 수용 규모
    parking_fee = db.Column(db.String(120), nullable=True)                                                                                                          # 주차장 요금
    requires_reservation = db.Column(db.Boolean, nullable=False)                                                                                                    # 예약 필요 여부    # 필수입력
    ...
    local_currency_available = db.Column(db.Boolean, nullable=False)                                                                                                # 지역화폐          # 필수입력
...
#     id = db.Column(db.Integer, primary_key=True, autoincrement=True)                                                                                                # activity 테이블에 액티비티 정보가 저장되면 생성 순선대로 자동으로 만들어짐
#     province = db.Column(db.String(120), nullable=False)                                                                                                            # 도                # 필수입력
#     city = db.Column(db.String(120), nullable=False)                                                                                                                # 시                # 필수입력
#     name = db.Column(db.String(120), nullable=False)                                                                                                                # 이름              # 필수입력
#     address = db.Column(db.String(200), nullable=False)                                                                                                             # 주소              # 필수입력
#     contact_number = db.Column(db.String(50), nullable=True)                                                                                                        # 대표 전화번호
#     website_url = db.Column(db.String(200), nullable=True)                                                                                                          # 홈페이지
...
#     id = db.Column(db.Integer, primary_key=True, autoincrement=True)                                                                                                # festivals 테이블에 축제 정보가 저장되면 생성 순선대로 자동으로 만들어짐
#     province = db.Column(db.String(120), nullable=False)                                                                                                            # 도               # 필수입력
#     city = db.Column(db.String(120), nullable=False)                                                                                                                # 시               # 필수입력
#     name = db.Column(db.String(120), nullable=False)                                                                                                                # 이름             # 필수입력
#     address = db.Column(db.String(200), nullable=False)                                                                                                             # 주소             # 필수입력
...
#     public_transportation = db.Column(db.Text, nullable=True)                                                                                                       # 대중교통
#     local_currency_available = db.Column(db.Boolean, nullable=False)                                                                                                # 지역화폐         # 필수입력
#     season = db.Column(db.String(50), nullable=False)                                                                                                               # 시즌             # 필수입력
#     created_at = db.Column(db.DateTime(timezone=True), nullable=False, default=lambda: datetime.now(timezone.utc))                                                  # 생성시간         # 자동입력     # 기본값있음
#     updated_at = db.Column(db.DateTime(timezone=True), nullable=False, default=lambda: datetime.now(timezone.utc), onupdate=lambda: datetime.now(timezone.utc))     # 수정시간         # 자동입력     # 기본값있음
