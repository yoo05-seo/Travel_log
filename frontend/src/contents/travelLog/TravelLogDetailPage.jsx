  ...
  <>
   ...
   <div className="tld-wrap">
    <div className="tld-content">
     ...
     <p>여행을 떠난다는 것은 단순히 지도를 따라 새로운 장소를 방문하는 행위가 아니다.
      익숙한 생활의 틀을 잠시 벗어나, 다른 공기와 다른 빛, 다른 사람들의 속도 속으로
      자신을 옮겨 놓는 일이다. 공항이나 기차역에 도착하는 순간부터 마음은 이미 여행자의
      리듬에 맞추어 천천히 흔들리기 시작한다. 가방의 무게는 가볍지 않지만, 그 안에는
      설렘과 기대가 함께 들어 있어 오히려 발걸음이 가벼워진다.</p>
    </div>
        ...
        <div className="tld-reply-list">
         <div className="tld-reply">
          ...
          <div className="tld-comment-content">
           ...
           <p className="tld-comment-text">대댓글1</p>
           <div className="tld-comment-action-row">
         ...
         <div className="tld-reply">
          ...
          <div className="tld-comment-content">
           ...
           <p className="tld-comment-text">대댓글2</p>
           <div className="tld-comment-action-row">
        ...
        <div className="tld-reply-list">
         <div className="tld-reply">
          ...
          <div className="tld-comment-content">
           ...
           <p className="tld-comment-text">대댓글3</p>
           <div className="tld-comment-action-row">
         ...
         <div className="tld-reply">
          ...
          <div className="tld-comment-content">
           ...
           <p className="tld-comment-text">대댓글4</p>
           <div className="tld-comment-action-row">
